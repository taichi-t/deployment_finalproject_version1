module.exports = {
  ...
  titleTemplate: "A hybrid learning platform specialized in social innovation", // Template for Page Titles
  description:
  ...
  // Manifest
  icon: "src/images/logo.png", // Used for manifest favicon generation
